    ...
    def setNumberCCEdges(self, CV, CE):
        ...
        for v in loop_verts:
            if (not CV[v]):
                ...
                break
        self.numberCCEdges = self.configs["loops"]  # Number of completely covered edges including loops
        self.ccEdges = [False] * self.configs["edges"]  # array of completely covered edges that are not loops
